...
今回はmini.nvimで環境構築をしてみたら使い勝手がとてもよかったので、シェアしよう！！という記事です。
...
次回はmini.nvimの各プラグインの紹介記事を書こうと思います。
...
mini.basicsの特徴として、option_toggle_prefixを設定することで`number`や`wrap`などをtoggleできるマッピングが追加されることです。
