...
## 経緯
[v 0.9.0](https://github.com/neovim/neovim/releases/tag/v0.9.0)から[$NVIM\_APPNAME](https://github.com/neovim/neovim/commit/d34c64e342dfba9248d1055e702d02620a1b31a8#diff-6893b15a0240d31940f114149ad217c547d3263efcaa2731906ea8c8fa9d7f39)という名前で環境変数を定義することにより、複数の環境を切替えられるようになりました。無知だった私は「`$XDG_CONFIG_HOME`ってlinuxとかで見る環境変数だからWindowsで使えないじゃないか...」と思っていましたが、試してみたところWindowsでも使えたため、ウキウキでサブ環境を作りこの記事を書き始めました。  
