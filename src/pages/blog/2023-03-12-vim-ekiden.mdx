...
import vim from '../../assets/2023-03-12-vim-ekiden/vim-set-guifont'
import neovim from '../../assets/2023-03-12-vim-ekiden/neovim-set-guifont'
...
- vim
<img src={vim}>vimで:set guifont=*と入力</img>

- neovim
<img src={neovim}>neovimで:set guifont=*と入力</img>
